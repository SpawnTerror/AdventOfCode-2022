...
while len(data) >0:
    ...
    # Check if any of the sets contains in each other at all
    if elfOne.intersection(elfTwo) or elfTwo.intersection(elfOne):
        sum += 1

print('Assignment pairs that overlap = ', sum)