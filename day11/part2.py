...
def divideMod():
    modValue = 1
    allDivs = [int(monkeyDict[monkey]['Divide']) for monkey in monkeyDict]
        ...
        for monkey in monkeyDict:
            ...
            if noOfItems >0:
                for item in itemsToCheck:
                    ...
                    newWorryLevel = newWorryLevel % modValue
                    divisible = checkIfDivisible(monkey, newWorryLevel)
                    x = throwItem(monkey, item, newWorryLevel, divisible)
    return countItems
